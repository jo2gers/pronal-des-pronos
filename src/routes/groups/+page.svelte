...
<div class="space-y-6">
	...
	{#if data.pendingRequests.length > 0}
		<div class="rounded-xl bg-panel border border-wire p-4">
			<h2 class="text-base font-semibold text-fg mb-3 flex items-baseline gap-2" style="font-family: var(--font-display)">
				{t('groups_pending_title')}
				<span class="text-xs text-faint font-normal tabular-nums">{data.pendingRequests.length}</span>
			</h2>
			<div class="space-y-2">
