...
export const actions: Actions = {
	update: async ({ request, locals: { supabase, safeGetSession } }) => {
		...
		// V2: the favourite CLUB is per-competition (picked on the profile via
		// /[comp]/team) — this settings page only edits the account fields.
		// profiles.favorite_team stays the frozen WC archive value.
