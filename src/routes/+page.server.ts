...
export const load: PageServerLoad = async ({ locals: { supabase, safeGetSession } }) => {
	...
	const matchFields = 'id, home_team, away_team, home_flag, away_flag, stage, group_label, match_datetime, venue, status, home_score, away_score, odds_home, odds_draw, odds_away, live_elapsed, live_period';
